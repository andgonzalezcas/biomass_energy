const CardProfile = ({ name, career, rol, rolFull, image }) => {
  return (
    <div className="flex flex-col justify-center max-w-xs p-6 shadow-md rounded-xl sm:px-12 bg-gray-900 text-gray-100 h-full">
      <img src={image || "https://source.unsplash.com/150x150/?portrait?3"} alt="" className="w-32 h-32 mx-auto rounded-full dark:bg-gray-500 aspect-square" />
      <div className="space-y-4 text-center divide-y divide-gray-700">
        <div className="my-2 space-y-1">
          <h2 className="text-xl font-semibold sm:text-2xl">{name}</h2>
          <p className="px-5 text-xs sm:text-base dark:text-gray-400">{career}</p>
          <p className="px-5 text-xs sm:text-base dark:text-gray-400">{rol} - {rolFull}</p>
        </div>
